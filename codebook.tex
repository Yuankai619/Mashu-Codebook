...
\fancyhead[L]{National Taiwan Ocean University Mashu}
\fancyhead[R]{\thepage}
...
\lstinputlisting{basic/fast_read_write.cpp}

\subsection{Sort cmp}
\lstinputlisting{basic/sort_cmp.cpp}

\subsection{Set sort cmp}
\lstinputlisting{basic/set_sort_cmp.cpp}

\subsection{K base input}
\lstinputlisting{basic/k_base_input.cpp}

\subsection{Debug}
\lstinputlisting{basic/debug.cpp}
...
\subsection{輸出匹配 Index or Tarjan+all edge}
\lstinputlisting{flow/TarjanWithAllEdges.cpp}
...
\subsection{矩陣掃描線}
\lstinputlisting{geometry/Sweep_Line.cpp}

\subsection{Pick theorem}
\lstinputlisting{geometry/Pick.cpp}
...
\subsection{Segment tree1}
\lstinputlisting{dataStructure/Segment_tree1.cpp}

\subsection{Segment tree1}
\lstinputlisting{dataStructure/Segment_tree2.cpp}

\subsection{Persistent Segment tree}
\lstinputlisting{dataStructure/Persistent_segment_tree.cpp}

\subsection{持久化並查集}
\lstinputlisting{dataStructure/DSU_Rollback.cpp}

\subsection{Treap}
\lstinputlisting{dataStructure/treap.cpp}

\subsection{CDQ 分治}
\lstinputlisting{dataStructure/CDQ_DC.cpp}
...
\subsection{Maze}
\lstinputlisting{others/Maze.cpp}
